...
public class ServerManager implements IServer
{
    ...
    @Override
    public Server get(String id) throws ServerNotFoundException
    {
    ...
    @Override
    public void create(Server server) throws ServerNotFoundException
    {
        ...
        data.put("status", server.getServerStatus().getName());
        jedis.hmset(KEY + server.getId(), data);
        jedis.close();
    }

    @Override
    public void delete(Server server) throws ServerNotFoundException
    {
        Jedis jedis = RedisConnection.getInstance().getJedisPool().getResource();
    ...
    @Override
    public void update(Server server) throws ServerNotFoundException
    {
        create(server);
    }
}
