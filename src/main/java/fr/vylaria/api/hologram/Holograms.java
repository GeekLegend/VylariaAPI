package fr.vylaria.api.hologram;
...
public class Holograms
{
	...
	public Holograms(String... lines)
	{
		...
		this.taskID = Bukkit.getScheduler().runTaskTimerAsynchronously(VylariaAPI.getInstance(), this::sendLinesForPlayers, 10L, 10L);
	}
